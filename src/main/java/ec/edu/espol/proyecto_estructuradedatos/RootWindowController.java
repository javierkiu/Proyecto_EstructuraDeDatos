...
public class RootWindowController implements Initializable {
    ...
    private DoublyCircularLinkedList<Auto> carros;
    @FXML
    ...
    public void dibujarLista()
    {
        ...
        if(!carros.isEmpty())
        {
            ...
            for(DoublyCircularNodeList<Auto> v = carros.getLast().getNext();v != carros.getLast(); v = v.getNext())
            {
                ...
                im.addEventHandler(MouseEvent.MOUSE_CLICKED,(MouseEvent t) -> { 
                    Platform.runLater(() -> {
                        ...
                        b1.addEventHandler(MouseEvent.MOUSE_CLICKED, (MouseEvent t1) -> {dibujarLista();});
